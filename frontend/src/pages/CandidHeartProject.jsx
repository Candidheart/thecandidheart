      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center border border-primary/20 hover:border-primary/40 transition-colors">
              <CardContent className="p-8">
            ...
            <Card className="text-center border border-accent/20 hover:border-accent/40 transition-colors">
              <CardContent className="p-8">
            ...
            <Card className="text-center border border-secondary/40 hover:border-secondary/60 transition-colors">
              <CardContent className="p-8">
