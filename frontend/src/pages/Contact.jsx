      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            {/* Book a Call */}
            <Card className="group hover:shadow-lg transition-all border-2 border-primary/20 hover:border-primary/40">
            ...
            {/* Send Message */}
            <Card className="group hover:shadow-lg transition-all border-2 border-accent/20 hover:border-accent/40">
              <CardContent className="p-8 text-center">
            ...
            {/* Email Direct */}
            <Card className="group hover:shadow-lg transition-all border-2 border-secondary/40 hover:border-secondary/60">
              <CardContent className="p-8 text-center">
